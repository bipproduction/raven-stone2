'use client'
import { ActionIcon, Avatar, BackgroundImage, Box, Button, Center, CloseButton, Flex, Grid, Group, Image, Stack, Text } from "@mantine/core";
...
import kabu from "..//../dashboard_live/components/asset-data/kab_prov.json"
import provi from "..//../dashboard_live/components/asset-data/prov.json"
...
export default function DashboardLive2Paslon({ dataPersen, dataNotif, emotionPersen }: { dataPersen: any, dataNotif: any, emotionPersen: any }) {
      ...
      <Flex h={"95vh"} >
        ...
        <Box
          ...
          <Stack
            ...
            >
              <Stack>
                <Flex align={"center"} gap={"120"} justify={"center"}>
                  <Stack>
            ...
            >
              <Stack>
                <Flex align={"center"} gap={"120"} justify={"center"}>
                  <Stack>
                    <Image width={150} height={150} src={"/assets-img/ganjar.png"} alt="" />
                    <BackgroundImage src="/assets-img/bg_title.png" p={"xs"}>
                      <Center><Text>GANJAR</Text></Center>
                    </BackgroundImage>
                  </Stack>
                  <Stack>
                    <Image width={150} height={150} src={"/assets-img/mahfud.png"} alt="" />
                    <BackgroundImage src="/assets-img/bg_title.png" p={"xs"} >
                      <Center><Text>MAHFUD</Text></Center>
                    </BackgroundImage>
                  </Stack>
                </Flex>
                <Group
                  ...
                  <Flex align={"center"} p={0}>
                    <Flex px={"lg"} pb={10} direction={"column"} gap={0} p={0} >
                      <Text style={{
                        fontSize: 20,
                        fontWeight: "bolder"
                      }}>{_.isNaN(emotionPersen[3].positive) ? 0 : emotionPersen[3].positive} %</Text>
                      <Group justify="end" style={{
                        fontWeight: "bold"
                      }} p={0} c={"white"} >
                        <Text style={{
                  ...
                  <Flex align={"center"} p={0}>
                    <Flex px={"lg"} pb={10} direction={"column"} gap={0} p={0} >
                      <Text style={{
                        fontSize: 20,
                        fontWeight: "bolder"
                      }}>{_.isNaN(emotionPersen[3].neutral) ? 0 : emotionPersen[3].neutral} %</Text>
                      <Group justify="end" style={{
                        fontWeight: "bold"
                      }} p={0} c={"white"} >
                        <Text style={{
                  ...
                  <Flex align={"center"} p={0}>
                    <Flex px={"lg"} pb={10} direction={"column"} gap={0} p={0} >
                      <Text style={{
                        fontSize: 20,
                        fontWeight: "bolder"
                      }}>{_.isNaN(emotionPersen[3].negative) ? 0 : emotionPersen[3].negative} %</Text>
                      <Group justify="end" style={{
                        fontWeight: "bold"
                      }} p={0} c={"white"} >
                        <Text style={{
