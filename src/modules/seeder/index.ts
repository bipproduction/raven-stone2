import ViewSeeder from "./view/view_seeder";
...
import seederPersenLive from "./data/persen_live.json"
...
import { funSeederPersenLive } from "./fun/fun_persen_live";

export { ViewSeeder }
export { seederProvinsi }
export { seederPersenLive }
