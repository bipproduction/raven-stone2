...
export default function ViewAdminAudience({ param, provinsi, kabupaten, kecamatan, datatable, datadownload }: { param: any, provinsi: any, kabupaten: any, kecamatan: any, datatable: any, datadownload: any }) {
    ...
    function onProccess() {
        ...
        router.replace('/dashboard-admin/audience?prov=' + isProvinsi + '&city=' + isKabupaten + '&kec=' + isKecamatan)
    }
