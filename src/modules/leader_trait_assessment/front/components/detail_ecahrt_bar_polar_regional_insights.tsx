...
/**
 * Fungsi untuk menampilkan menampilkan detail echart bat polar regional insights.
 * @param {dataLta} dataLta - menampilkan dataLta.
 * @returns Untuk menampilkan menampilkan detail echart bat polar regional insights
 */
