'use client'
import { ActionIcon, Avatar, BackgroundImage, Box, Button, Center, CloseButton, Flex, Grid, Group, Image, ScrollArea, Stack, Text, Title, UnstyledButton } from "@mantine/core";
import { MdAccountCircle, MdArrowBackIos, MdArrowCircleRight, MdArrowDropDown, MdArrowDropUp, MdChangeHistory, MdComment, MdCommit, MdDelete, MdHeight, MdLocalFlorist, MdLteMobiledata, MdMap, MdMenuBook, MdMinimize, MdMoveUp, MdNotificationsActive, MdOpenInNew, MdOutlinePauseCircle, MdPlace, MdRemove, MdSwapHoriz, MdSwapVert } from "react-icons/md"
import { Inter, Roboto_Mono, Michroma } from 'next/font/google'
import list_province from './../../../public/assets-json/list_province.json'
import { useInterval, useShallowEffect, useViewportSize } from "@mantine/hooks";
import _, { shuffle, take } from "lodash";
import { useState } from "react";
import { TextLoop } from "easy-react-text-loop";
import kabu from './../../../public/asset-data/kab_prov.json'
import provi from './../../../public/asset-data/prov.json'
                        ...
                        <Stack>
                            ...
                            <Group
                                ...
                                {list_emotion.map((v, k) => <Flex key={k} align={"center"} p={0}>
                                    ...
                                    <MdArrowDropUp color={emotion_color(v.variant)} size={100} />
                                </Flex>)}
                            </Group>
                        </Stack>
                        <BackgroundImage
