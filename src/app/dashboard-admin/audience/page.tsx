import { ViewAdminAudience } from "@/modules/audience";
...
export default function Page({ searchParams }: { searchParams: { prov: any, city: any, kec: any } }) {
    ...
    return <ViewAdminAudience param={findData} provinsi={[]} kabupaten={[]} kecamatan={[]} datatable={{ title: null, data: [], th: [] }} datadownload={[]} />;
}