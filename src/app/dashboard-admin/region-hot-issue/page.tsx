import { ViewAdminRHI } from "@/modules/region_hot_issue";
...
export default function Page({ searchParams }: { searchParams: { prov: any, city: any, kec: any } }) {
    ...
    return <ViewAdminRHI param={findData} provinsi={[]} kabupaten={[]} kecamatan={[]} datatable={{ title: null, data: [], th: [] }} datadownload={[]} />;
}