...
- SWOT: halaman **Generate** yang mengisi data SWOT untuk seluruh kandidat (atau satu kandidat). Tiap kandidat diisi 4 kategori (STRENGTH/WEAKNESS/OPPORTUNITY/THREAT) dengan konten berupa 2-4 poin acak yang dirakit dari pool frasa Indonesia per kategori, sehingga berbeda tiap kali generate ulang. SWOT lama kandidat dinonaktifkan (`isActive`) lebih dulu lalu diisi ulang (replace).
